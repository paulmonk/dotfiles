# Claude Command: Create Worktrees

This command helps you create worktrees for all open pull requests on GitHub.

## Usage

To create worktrees, just type:
```
/create-worktrees
```
...
This command fetches all open pull requests using GitHub CLI, then creates a git worktree for each PR's branch in the `./tree/<BRANCH_NAME>` directory. It will also create a worktree for the main branch.
