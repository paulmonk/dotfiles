...
map(
	'n',
	'ssv',
	'<cmd>split<CR><cmd>wincmd p<CR><cmd>e#<CR>',
	{ desc = 'Split and go to prev' }
)
map(
	'n',
	'ssg',
	'<cmd>vsplit<CR><cmd>wincmd p<CR><cmd>e#<CR>',
	{ desc = 'Vsplit and go to prev' }
)
