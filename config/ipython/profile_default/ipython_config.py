...
# configuration (through profiles), history storage, etc.
# The default is usually $HOME/.ipython.
# This option can also be specified through the environment
# variable IPYTHONDIR.
...
# defined because otherwise you'll spend more time re-flushing a
# too small cache than working
